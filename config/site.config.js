...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ryc_null@outlook.com',
  ...
  protectedRoutes: ['/个人资料', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'ryc_null@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/null12138',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/',
